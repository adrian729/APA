...
# Dit tot això, reprenem el fil i tornem a l'error quadràtic mitjà. Sovint és convenient treballar amb la seva arrel, per obtenir així la "llargada" del vector d'errors
