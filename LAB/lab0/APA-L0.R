...
################################### INSTRUCCIONS (per tots els laboratoris)
# No cal entregar res, cal assimilar els conceptes

# S'ha de fer amb calma, sense córrer, mirant d'entendre en tot moment què s'està fent --a nivell conceptual-- i quin efecte té

# Podeu deixar el codi R en si (crides, paràmetres, sintaxi) per una segona lectura o com a treball personal. El llenguatge aquí és un mitjà, no un objectiu.
###################################
...
# decimal separator, column separator, possible headers, how are strings quoted, how (if any) are missing values coded, should character vectors be converted to factors?, should white spaces be stripped?, etc
